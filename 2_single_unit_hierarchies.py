...
sns.lineplot(ax=axs[1],data=filt_data,x='brain_region',y='FR',hue='species',ci=95,markers=True,legend=False,estimator=np.mean)
sns.pointplot(ax=axs[1],data=filt_data,x='brain_region',y='FR',hue='species',ci=None,scale=0.4)
...
axs[1].tick_params(axis='x', rotation=45,labelsize=7)
axs[1].tick_params(axis='y',labelsize=7)
axs[1].set_ylabel('FR (hz)',fontsize=7)
